...
//    var SANDBOX = "SANDBOX";
//    var LINEAIR = "LINEAIR";
//    var conf.gpsAvailable = 'conf.gpsAvailable';
//    var conf.gpsUnavailable = 'conf.gpsUnavailable';
...
//    var locatieRij = markerRij = [];
    ...
    function init(){
        ...
        (geo_position_js.init())?ET.fire(conf.gpsAvailable):ET.fire(conf.gpsUnavailable);
    }
